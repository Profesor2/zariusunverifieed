...
if(!message.member.roles.cache.some(r => ["795250882174124042"].includes(r.id)) && (!message.member.hasPermission("ADMINISTRATOR")))
...
.addField(`Toplam Kayıtların:`, ` <a:sagnbr:795201507724754945> \`${kayıtlar}\``)
.addField(`Toplam Erkek Kayıtların:`, ` <a:sagnbr:795201507724754945> \`${erkek}\``)
.addField(`Toplam Kadın Kayıtların:`, ` <a:sagnbr:795201507724754945> \`${kadın}\``)
.setColor('#dcdd64')
...
.addField(`<:Verified_proton:793092767491686400>  Toplam Kayıtların:`, `\`${kayıtlar1}\``)
.addField(`<:Verified_proton:793092767491686400>  Toplam Erkek Kayıtların:`, `\`${erkek1}\``)
.addField(`<:Verified_proton:793092767491686400>  Toplam Kadın Kayıtların:`, `\`${kadın1}\``)
.setColor('#dcdd64')
