...
if(!['795250882174124042'].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission('ADMINISTRATOR')) 
...
const tag = 'メ'   
const erkekrol = message.guild.roles.cache.find(r => r.id === '799225435673329665') 
const erkekrol2 = message.guild.roles.cache.find(r => r.id === '799225435673329665')
const kayıtsız = message.guild.roles.cache.find(r => r.id === '799225504472236052')
const genelchat = message.guild.channels.cache.find(c => c.id === '799219734214213672')
const savelog = message.guild.channels.cache.find(c => c.id === '799225371706785823')
